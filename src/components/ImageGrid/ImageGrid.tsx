...
export default function ImageGrid({
      ...
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="col-span-full flex flex-col items-center justify-center py-20 text-gray-400 dark:text-gray-500">
            ...
            <p className="text-xs mt-1 text-gray-400 dark:text-gray-600">{emptyHint}</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="w-full max-w-4xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {isLoading && (
          <div className="aspect-square rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 animate-pulse flex items-center justify-center">
